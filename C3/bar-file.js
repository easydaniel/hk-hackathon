...
d3.json("data/fake-data.json", function(error, json) {
	...
	$(document).mousemove(function() {    
	    /*if($("c3-shapes-America").is(":hover"))
	    {
	    	document.querySelector("#itemNumber").innerHTML = nowHover.america;	
	    }
	    if($("c3-shapes-China").is(":hover"))
	    {
	    	document.querySelector("#itemNumber").innerHTML = nowHover.china;
	    }*/
	    var myVar = $(".c3-target-China").hasClass( ".c3-focused" );
		console.log(myVar);
	});

	$('.c3-shapes-China').hover(function() {
		console.log(nowHover.china);
		document.querySelector("#itemNumber").innerHTML = nowHover.china;
	});
